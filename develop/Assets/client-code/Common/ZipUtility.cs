...
public class ZipFileCallBack : ZipUtility.ZipCallback
{
    private System.Action<bool> OnFinishedCallBack;

    public ZipFileCallBack(System.Action<bool> finishCallBack = null)
    {
...
public class UnZipFileCallBack : ZipUtility.UnzipCallback
{
    private System.Action<bool> OnFinishedCallBack;

    public UnZipFileCallBack(System.Action<bool> finishCallBack = null)
    {
        OnFinishedCallBack = finishCallBack;
    }
